...
def save_results(ticker, S0, r_curve, q_curve, res_params, options):
    ...
    base_name = f"results/calibration_MC_{ticker}_20260208_020354" #_20260208_020354 022951_meta.json
...
def main():
    ...
    mc_calib = BatesCalibratorMC(S0=S0_actual, r_curve=r_curve, q_curve=q_curve, n_paths=5000, n_steps=5000)  #5000 4000
